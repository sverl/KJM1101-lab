% type dokument. Her kan globale preferanser for skriftstørrelse, arkformat osv. presiseres
...
% Kjemi! Eksempel: \ce{H2SO3 + H2O <=> H2SO3- + H3O+}
\usepackage[version=3]{mhchem}

% Pene tabeller
\usepackage{booktabs}

% Warning: Rabbit hole, stay clear!
\usepackage{tikz}
...
\newcommand{\fixme}[1]{\textbf{{\color{red} \textsc{FIXME:} #1 }}}
\newcommand{\pH}{\ensuremath{pH}}

% Matte og kvantemekk. Lar de stå som eksempel.
\newcommand{\nparens}[1]{\left(#1\right)}
\newcommand{\bparens}[1]{\left[#1\right]}
\newcommand{\rparens}[1]{\langle#1\rangle}
\newcommand{\lparens}[1]{\left|#1\right|}
\newcommand{\cparens}[1]{\left\{#1\right\}}
\newcommand{\partiali}[2]{\frac{\partial#1}{\partial #2}}
\newcommand{\partialii}[2]{\frac{\partial^2#1}{\partial #2^2}}
\newcommand{\partialij}[3]{\frac{\partial^2#1}{\partial #2 \partial #3}}
\newcommand{\myvec}[1]{\boldsymbol{#1}}
\newcommand{\myvecII}[1]{\vec{#1}}
\newcommand{\bra}[1]{\left\langle#1\right|}
\newcommand{\ket}[1]{\left|#1\right\rangle}
\newcommand{\braket}[2]{\left\langle#1\;\vline\;#2\right\rangle}
\newcommand{\expectation}[3]{\left\langle#1\;\vline\;#2\;\vline\;#3\right\rangle}
\newcommand{\twoint}[2]{\left\langle#1\;\vline\;\vline\;#2\right\rangle}
\newcommand{\cbraket}[2]{\left(#1\;\vline\;#2\right)}
\newcommand{\CR}[1]{\ensuremath{\hat{a}^\dagger_{#1}}}
\newcommand{\AN}[1]{\ensuremath{\hat{a}_{#1}}}
\newcommand{\bCR}[1]{\ensuremath{\hat{b}^\dagger_{#1}}}
\newcommand{\bAN}[1]{\ensuremath{\hat{b}_{#1}}}
\renewcommand{\H}{\ensuremath{\hat{H}}}
\newcommand{\pert}[1]{\ensuremath{^{(#1)}}}
\newcommand{\cmark}{\color{ForestGreen}\boldsymbol{\checkmark}}%
\newcommand{\xmark}{\color{red}\textbf{X}}%
\allowdisplaybreaks[1] % displaybreak in math is allowed but avoided



%% ========================================================================== %%
%% Tittel, forfatter og dato
%% ========================================================================== %%
