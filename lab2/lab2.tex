...
\begin{document}
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Sammenhengen mellom temperatur og vannets damptrykk. Data fra \cref{tbl:vap} (kryss) med lineær interpolasjon (linjer).}
		\label{fig:vap}
	\end{figure}
