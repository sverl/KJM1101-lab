...
%				\addplot [no markers] table [y=regression] {\loadedtable};
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\item Gjenta \crefrange{lst:firststep}{lst:fourthstep} for volumene i \Cref{tbl:cal}.
		\end{enumerate}
		...
		\begin{enumerate}
			...
			\item Gjør totalt minst fem replikater av \crefrange{lst:firststep2}{lst:fourthstep2}.
	...
	\begin{table}[p]
		...
		\begin{tabular}{S[table-format=2]llll}
			\toprule
			$V_{\ch{HNO3}}/\si{\milli\litre}$ & $V_{\ch{NaOH}}/\si{\litre}$ & $T_{\ch{HNO3}}/\si{\degreeCelsius}$ & $T_{\ch{NaOH}}/\si{\degreeCelsius}$ & $T/\si{\degreeCelsius}$ \\ \midrule
	...
	\begin{table}[p]
		...
		\begin{tabular}[t]{S[table-format=1]l}
			\toprule
			$t/\si{\minute}$ & $T/\si{\degreeCelsius}$ \\ \midrule
			               1 &     \cellcolor{blue!10} \\
			               2 &     \cellcolor{blue!10} \\ 
			               3 &     \cellcolor{blue!10} \\
			               4 &     \cellcolor{blue!10} \\
			               ...
			               6 &     \cellcolor{blue!10} \\
			               7 &     \cellcolor{blue!10} \\
			               8 &     \cellcolor{blue!10} \\ \bottomrule 
		\end{tabular}
		\begin{tabular}[t]{S[table-format=1]l}
			\toprule
			$t/\si{\minute}$ & $T/\si{\degreeCelsius}$ \\ \midrule
			               9 &     \cellcolor{blue!10} \\
			              10 &     \cellcolor{blue!10} \\
			              11 &     \cellcolor{blue!10} \\
			              12 &     \cellcolor{blue!10} \\
			              13 &     \cellcolor{blue!10} \\
			              14 &     \cellcolor{blue!10} \\
			              15 &     \cellcolor{blue!10} \\ \bottomrule 
		\end{tabular}      
	\end{table}	
	...
	\begin{table}[p]
		...
		\begin{tabular}{r S[table-format=2.1] S[table-format=2.1] S[table-format=2.1] l}
			\toprule
			Replikat & $T_\mathrm{k}/\si{\degreeCelsius}$ & $T_\mathrm{v}/\si{\degreeCelsius}$ & $T/\si{\degreeCelsius}$ & $C_\mathrm{cal}/\si{\joule\per\kelvin}$ \\ \midrule
			       1 &                \cellcolor{blue!10} &                \cellcolor{blue!10} &     \cellcolor{blue!10} &                     \cellcolor{blue!10} \\
			       2 &                \cellcolor{blue!10} &                \cellcolor{blue!10} &     \cellcolor{blue!10} &                     \cellcolor{blue!10} \\ 
			       3 &                \cellcolor{blue!10} &                \cellcolor{blue!10} &     \cellcolor{blue!10} &                     \cellcolor{blue!10} \\
			       4 &                \cellcolor{blue!10} &                \cellcolor{blue!10} &     \cellcolor{blue!10} &                     \cellcolor{blue!10} \\
			       5 &                \cellcolor{blue!10} &                \cellcolor{blue!10} &     \cellcolor{blue!10} &                     \cellcolor{blue!10} \\ \midrule
			                                                                            \multicolumn{4}{r}{gjennomsnitt} &                     \cellcolor{blue!10} \\
			                                                                            \multicolumn{4}{r}{standardfeil} &                     \cellcolor{blue!10} \\ \bottomrule 
		\end{tabular}
	\end{table}
	...
	Oppsummer resultatene dine i tabeller som angir alle målte temperaturer og beregnede størrelser tilsvarende \crefrange{ẗbl:calexample}{tbl:calheatcap} og figurer der regresjon har blitt brukt samt dataene fra \cref{tbl:heatloss}.
