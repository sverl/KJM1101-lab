...
%				\addplot [no markers] table [y=regression] {\loadedtable};
	...
	\begin{table}
		...
		\begin{tabular}{r S[table-format=1.4] S[table-format=1.4] S[table-format=2.1] S[table-format=2.1] S[table-format=2.1]}
			\toprule
			Replikat & $V_{\ch{HCl}}/\si{\litre}$ & $V_{\ch{NaOH}}/\si{\litre}$ & $T_{\ch{HCl}}/\si{\degreeCelsius}$ & $T_{\ch{NaOH}}/\si{\degreeCelsius}$ & $T/\si{\degreeCelsius}$ \\ \midrule
			       1 &                     0.0100 &         \cellcolor{blue!10} &                               22.0 &                                22.8 &                    26.7 \\
			       2 &                     0.0200 &         \cellcolor{blue!10} &                               22.0 &                                22.7 &                    30.9 \\ 
			       3 &                     0.0300 &         \cellcolor{blue!10} &                               22.0 &                                22.8 &                    35.3 \\
			       4 &                     0.0400 &         \cellcolor{blue!10} &                               22.0 &                                23.0 &                    39.1 \\
			       5 &                     0.0500 &         \cellcolor{blue!10} &                               22.0 &                                22.7 &                    42.8 \\ \bottomrule 
		\end{tabular}                                                                                                                                                      
	\end{table}
	...
	I \vref{equipment} er nødvendig utstyr oppgitt.	Noter hvilken vekt du benytter og toleransen dens.
